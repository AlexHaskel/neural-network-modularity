...
The many experiments I ran are included as a zip file release at: 

https://github.com/AlexHaskel/neural-network-modularity/releases/download/v0.1.0/experiments.rar. 

If you wish to see each of the 44 original experiments, with all their original data 
summaries, and detailed metrics, please download this file.
